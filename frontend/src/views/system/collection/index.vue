<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="收藏ID" prop="collectionId">
        <el-input
    ...
    <el-table v-loading="loading" :data="collectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收藏ID" align="center" prop="collectionId" />
      <el-table-column label="学生ID" align="center" prop="studentId" />
      <el-table-column label="岗位ID" align="center" prop="postId" />
      <el-table-column label="收藏时间" align="center" prop="collectionTime" width="180">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除岗位收藏编号为"' + collectionIds + '"的数据项？').then(function() {
