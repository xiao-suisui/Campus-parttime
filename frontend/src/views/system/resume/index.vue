  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="求职意向" prop="expectedPosition">
        <el-input
          v-model="queryParams.expectedPosition"
          placeholder="请输入求职意向"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="期望薪资下限" prop="expectedSalaryMin">
        <el-input
          v-model="queryParams.expectedSalaryMin"
          placeholder="请输入期望薪资下限"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="期望薪资上限" prop="expectedSalaryMax">
        <el-input
          v-model="queryParams.expectedSalaryMax"
          placeholder="请输入期望薪资上限"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="resumeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="求职意向" align="center" prop="expectedPosition" />
      <el-table-column label="期望薪资下限" align="center" prop="expectedSalaryMin" />
      <el-table-column label="期望薪资上限" align="center" prop="expectedSalaryMax" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学生简历编号为"' + resumeIds + '"的数据项？').then(function() {
